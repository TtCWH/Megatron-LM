...
DATASET_FILE=/workspace/dataset/matrix_clean/data.txt
...
#TOKENIZER_PATH=/workspace/dataset/zjllm-llama3-tokenizer
TOKENIZER_PATH=/workspace/dataset/Qwen2-7B-Instruct
...
HIDDEN_SIZE=128 # e.g. llama-13b: 5120
FFN_HIDDEN_SIZE=384 # e.g. llama-13b: 13824
NUM_LAYERS=4 # e.g. llama-13b: 40
NUM_HEADS=4 # e.g. llama-13b: 40
SEQ_LENGTH=128
